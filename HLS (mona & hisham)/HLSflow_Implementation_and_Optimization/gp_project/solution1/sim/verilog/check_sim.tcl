...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.conv_test.autotvin_image_r.dat"
         "c.conv_test.autotvin_weights.dat"
         "c.conv_test.autotvin_output_conv.dat"
         "c.conv_test.autotvout_output_conv.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.conv_test.autotvout_output_conv.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
