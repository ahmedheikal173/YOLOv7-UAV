...
module AESL_automem_output_conv (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.conv_test.autotvin_output_conv.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.conv_test.autotvout_output_conv.dat"; 
//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 32;
parameter ADDR_WIDTH = 32'd 17;
parameter DEPTH = 32'd 102400;
parameter DLY = 0.1;
