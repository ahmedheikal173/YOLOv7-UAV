...
if {[file isfile conv_test.autotvin.dat]} {
	file delete -force conv_test.autotvin.dat
}

if {[file isfile conv_test.autotvout.dat]} {
	file delete -force conv_test.autotvout.dat
}
