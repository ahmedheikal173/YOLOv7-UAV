...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "circular_shift_reg.autotvin.dat"
	set constFileTvOut       "circular_shift_reg.autotvout.dat"
	set constFileHdlTvIn     "circular_shift_reg.autohdltvin.dat"
	set constFileHdlTvOut    "circular_shift_reg.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
