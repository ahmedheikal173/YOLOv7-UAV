...
`define AUTOTB_DUT      circular_shift_reg
`define AUTOTB_DUT_INST AESL_inst_circular_shift_reg
`define AUTOTB_TOP      apatb_circular_shift_reg_top
`define AUTOTB_LAT_RESULT_FILE "circular_shift_reg.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "circular_shift_reg.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_circular_shift_reg_top
...
`define AUTOTB_TVIN_din  "./c.circular_shift_reg.autotvin_din.dat"
`define AUTOTB_TVIN_dout  "./c.circular_shift_reg.autotvin_dout.dat"
`define AUTOTB_TVIN_din_out_wrapc  "./rtl.circular_shift_reg.autotvin_din.dat"
`define AUTOTB_TVIN_dout_out_wrapc  "./rtl.circular_shift_reg.autotvin_dout.dat"
`define AUTOTB_TVOUT_dout  "./c.circular_shift_reg.autotvout_dout.dat"
`define AUTOTB_TVOUT_dout_out_wrapc  "./impl_rtl.circular_shift_reg.autotvout_dout.dat"
module `AUTOTB_TOP;
