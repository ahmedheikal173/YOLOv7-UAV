...
__attribute__((sdx_kernel("BRAM_filter", 0))) void BRAM_filter(ap_int<8> x_in[396], ap_int<8> out[396], bool load);
...
# 3 "../src/BRAM_flt.cpp" 2


__attribute__((sdx_kernel("BRAM_filter", 0))) void BRAM_filter(ap_int<8> x_in[396], ap_int<8> out[396], bool load) {_ssdm_SpecArrayDimSize(x_in, 396);_ssdm_SpecArrayDimSize(out, 396);
#pragma HLSDIRECTIVE TOP name=BRAM_filter
# 5 "../src/BRAM_flt.cpp"
...
# 19 "../src/BRAM_flt.cpp"
    if(load){
        VITIS_LOOP_20_1: for(int i=0; i<396;i+=1){
#pragma HLS PIPELINE II=1
 x.flt_load(x_in,i);
        ...
        VITIS_LOOP_27_2: for(int i=0; i<396;i+=1){
#pragma HLS PIPELINE II=1
 out[i] = x.flt_read(i);
        }
