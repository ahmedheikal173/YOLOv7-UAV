...
# 1 "../src/./RAM.h" 1
# 1 "../src/./BRAM_flt.hpp" 1




# 1 "../src/../include/ap_int.h" 1
# 6 "../src/./BRAM_flt.hpp" 2
# 1 "../src/./RAM.h" 1
# 1 "../src/./BRAM_flt.hpp" 1
# 2 "../src/./RAM.h" 2
# 1 "../src/./BRAM_img.hpp" 1




# 1 "../src/../include/ap_int.h" 1
# 6 "../src/./BRAM_img.hpp" 2
# 1 "../src/./RAM.h" 1
# 1 "../src/./BRAM_flt.hpp" 1
# 2 "../src/./RAM.h" 2
# 1 "../src/./BRAM_img.hpp" 1
...
typedef ap_int<8> ftype[3][3][44];
# 21 "../src/./RAM.h"
typedef ap_int<8> imtype[640][640][3];




void BRAM_filter(ap_int<8> x_in[396], ap_int<8> out[396], bool load);
void BRAM_image(ap_int<8> x_in[1228800], ap_int<8> out[1228800], bool load);
# 7 "../src/./BRAM_img.hpp" 2
...
class bram_img {
    public:
        ap_int<8> mems[1228800];
    public:
        bram_img(){
#pragma HLS BIND_STORAGE variable=mems type=RAM_1P impl=BRAM
 }

        void img_load(ap_int<8> x_in[1228800],ap_int<21> i){

                mems[i]=x_in[i];
        }

        ap_int<8> img_read(ap_int<21> i){
...
#pragma HLS BIND_STORAGE variable=mems type=RAM_1P impl=BRAM
        ...
        void flt_load(ap_int<8> x_in[396],ap_int<9> i){

                mems[i]=x_in[i];
        }

        ap_int<8> flt_read(ap_int<9> i){
...
void BRAM_filter(ap_int<8> x_in[396], ap_int<8> out[396], bool load);
void BRAM_image(ap_int<8> x_in[1228800], ap_int<8> out[1228800], bool load);
# 3 "../src/./tomatrix.hpp" 2
# 25 "../src/./tomatrix.hpp"
void frommatrixI(imtype mm_in, ap_int<8> mm_out[1228800]);
void tomatrixI(ap_int<8> m_in[1228800],imtype m_out);


void frommatrixF(ftype mmI_in, ap_int<8> mmI_out[396]);
void tomatrixF(ap_int<8> mI_in[396],ftype mI_out);
# 2 "../src/tomatrix.cpp" 2
...
#pragma HLS interface mode=BRAM port=m_in
#pragma HLS interface mode=BRAM port=m_out
int idx=0;
  VITIS_LOOP_11_1: for (int k = 0; k < 3; k += 1){

    VITIS_LOOP_13_2: for (int i = 0; i < 640; i += 1){

      VITIS_LOOP_15_3: for (int j = 0; j < 640; j += 1){
...
#pragma HLS interface mode=BRAM port=mm_in
#pragma HLS interface mode=BRAM port=mm_out
int idx=0;
  VITIS_LOOP_30_1: for (int k = 0; k < 3; k += 1){

    VITIS_LOOP_32_2: for (int i = 0; i < 640; i += 1){

      VITIS_LOOP_34_3: for (int j = 0; j < 640; j += 1){
#pragma HLS PIPELINE II=1
...
#pragma HLS interface mode=BRAM port=mI_in
#pragma HLS interface mode=BRAM port=mI_out
int idx=0;
  VITIS_LOOP_49_1: for (int k = 0; k < 44; k += 1){

    VITIS_LOOP_51_2: for (int i = 0; i < 3; i += 1){

      VITIS_LOOP_53_3: for (int j = 0; j < 3; j += 1){
#pragma HLS PIPELINE II=1
...
#pragma HLS interface mode=BRAM port=mmI_in
#pragma HLS interface mode=BRAM port=mmI_out
int idx=0;
  VITIS_LOOP_68_1: for (int k = 0; k < 44; k += 1){

    VITIS_LOOP_70_2: for (int i = 0; i < 3; i += 1){

      VITIS_LOOP_72_3: for (int j = 0; j < 3; j += 1){
#pragma HLS PIPELINE II=1
