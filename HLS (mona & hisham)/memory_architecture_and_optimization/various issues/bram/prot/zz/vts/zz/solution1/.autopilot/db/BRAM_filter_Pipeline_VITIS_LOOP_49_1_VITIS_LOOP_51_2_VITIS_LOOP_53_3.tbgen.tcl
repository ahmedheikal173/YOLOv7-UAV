set moduleName BRAM_filter_Pipeline_VITIS_LOOP_49_1_VITIS_LOOP_51_2_VITIS_LOOP_53_3
set isTopModule 0
...
set C_modelName {BRAM_filter_Pipeline_VITIS_LOOP_49_1_VITIS_LOOP_51_2_VITIS_LOOP_53_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ out_r int 8 regular {bram 396 { 0 3 } 0 1 }  }
	{ outt_V int 8 regular {array 396 { 1 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "out_r", "interface" : "bram", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "outt_V", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ out_r_WEN_A sc_out sc_lv 1 signal 0 } 
	{ out_r_Din_A sc_out sc_lv 8 signal 0 } 
	{ out_r_Dout_A sc_in sc_lv 8 signal 0 } 
	{ outt_V_address0 sc_out sc_lv 9 signal 1 } 
	{ outt_V_ce0 sc_out sc_logic 1 signal 1 } 
	{ outt_V_q0 sc_in sc_lv 8 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "outt_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "outt_V", "role": "q0" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ama_addmuladd_5s_2ns_6ns_6ns_9_4_1_U6", "Parent" : "0"},
...
set Spec2ImplPortList { 
	out_r { bram {  { out_r_Addr_A MemPortADDR2 1 32 }  { out_r_EN_A MemPortCE2 1 1 }  { out_r_WEN_A MemPortWE2 1 1 }  { out_r_Din_A MemPortDIN2 1 8 }  { out_r_Dout_A MemPortDOUT2 0 8 } } }
	outt_V { ap_memory {  { outt_V_address0 mem_address 1 9 }  { outt_V_ce0 mem_ce 1 1 }  { outt_V_q0 in_data 0 8 } } }
}
