...
#pragma HLS BIND_STORAGE variable=mems type=RAM_1P impl=BRAM
        ...
        void img_load(ap_int<8> x_in[1228800],ap_uint<21> i){

                mems[i]=x_in[i];
        }

        ap_int<8> img_read(ap_uint<21> i){
...
#pragma HLS BIND_STORAGE variable=mems type=RAM_1P impl=BRAM
        ...
        void flt_load(ap_int<8> x_in[396],ap_uint<9> i){

                mems[i]=x_in[i];
        }

        ap_int<8> flt_read(ap_uint<9> i){
