...
attribute shreg_extract : string;
    ...
    signal indvars_iv86_fu_96 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
    ...
    indvars_iv86_fu_96_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
                    indvars_iv86_fu_96 <= ap_const_lv9_0;
                elsif ((ap_enable_reg_pp0_iter2 = ap_const_logic_1)) then 
    ...
    add_ln49_1_fu_339_p2 <= std_logic_vector(unsigned(indvars_iv86_fu_96) + unsigned(ap_const_lv9_9));
