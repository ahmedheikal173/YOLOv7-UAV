...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "BRAM_filter.autotvin.dat"
	set constFileTvOut       "BRAM_filter.autotvout.dat"
	set constFileHdlTvIn     "BRAM_filter.autohdltvin.dat"
	set constFileHdlTvOut    "BRAM_filter.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
