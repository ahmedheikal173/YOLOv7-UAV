...
`define AUTOTB_DUT      interleave_manual_rnd
`define AUTOTB_DUT_INST AESL_inst_interleave_manual_rnd
`define AUTOTB_TOP      apatb_interleave_manual_rnd_top
`define AUTOTB_LAT_RESULT_FILE "interleave_manual_rnd.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "interleave_manual_rnd.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_interleave_manual_rnd_top
...
`define AUTOTB_TVIN_x_in_out_wrapc  "../tv/rtldatafile/rtl.interleave_manual_rnd.autotvin_x_in.dat"
`define AUTOTB_TVIN_y_out_wrapc  "../tv/rtldatafile/rtl.interleave_manual_rnd.autotvin_y.dat"
`define AUTOTB_TVIN_load_out_wrapc  "../tv/rtldatafile/rtl.interleave_manual_rnd.autotvin_load.dat"
`define AUTOTB_TVOUT_y  "../tv/cdatafile/c.interleave_manual_rnd.autotvout_y.dat"
`define AUTOTB_TVOUT_y_out_wrapc  "../tv/rtldatafile/rtl.interleave_manual_rnd.autotvout_y.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 2;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 1228803;
