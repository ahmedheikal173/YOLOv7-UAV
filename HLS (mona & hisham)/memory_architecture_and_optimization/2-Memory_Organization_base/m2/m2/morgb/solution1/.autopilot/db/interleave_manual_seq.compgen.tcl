...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 13 \
			corename interleave_manual_seq_control_axilite \
			name interleave_manual_seq_control_s_axi \
			ports {$port_control} \
			op interface \
			interrupt_mode none \
			is_flushable 0 \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler interleave_manual_seq_control_s_axi BINDTYPE interface TYPE interface_s_axilite
}
