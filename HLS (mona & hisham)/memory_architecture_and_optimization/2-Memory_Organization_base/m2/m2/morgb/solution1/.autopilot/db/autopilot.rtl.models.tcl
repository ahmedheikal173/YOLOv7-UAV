set SynModuleInfo {
  ...
  {SRCNAME interleave_manual_seq MODELNAME interleave_manual_seq RTLNAME interleave_manual_seq IS_TOP 1
    SUBMODULES {
      {MODELNAME interleave_manual_seq_x_x0_V_RAM_1P_BRAM_1R1W RTLNAME interleave_manual_seq_x_x0_V_RAM_1P_BRAM_1R1W BINDTYPE storage TYPE ram_1p IMPL bram LATENCY 2 ALLOW_PRAGMA 1}
