...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename x_x0_V \
    op interface \
    ports { x_x0_V_address0 { O 19 vector } x_x0_V_ce0 { O 1 bit } x_x0_V_we0 { O 1 bit } x_x0_V_d0 { O 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename x_x1_V \
    op interface \
    ports { x_x1_V_address0 { O 19 vector } x_x1_V_ce0 { O 1 bit } x_x1_V_we0 { O 1 bit } x_x1_V_d0 { O 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename x_x2_V \
    op interface \
    ports { x_x2_V_address0 { O 19 vector } x_x2_V_ce0 { O 1 bit } x_x2_V_we0 { O 1 bit } x_x2_V_d0 { O 8 vector } } \
} "
} else {
...
set InstName interleave_manual_seq_flow_control_loop_pipe_sequential_init_U
set CompName interleave_manual_seq_flow_control_loop_pipe_sequential_init
set name flow_control_loop_pipe_sequential_init
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix interleave_manual_seq_ \
}"
} else {
