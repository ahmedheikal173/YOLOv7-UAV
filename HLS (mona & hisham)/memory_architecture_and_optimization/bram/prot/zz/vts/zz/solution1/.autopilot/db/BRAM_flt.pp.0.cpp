...
__attribute__((sdx_kernel("BRAM_filter", 0))) void BRAM_filter(ftype x_in, ftype out, bool load);
...
__attribute__((sdx_kernel("BRAM_filter", 0))) void BRAM_filter(ftype x_in, ftype out, bool load) {_ssdm_SpecArrayDimSize(x_in, 3);_ssdm_SpecArrayDimSize(out, 3);
