...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "window_avg.autotvin.dat"
	set constFileTvOut       "window_avg.autotvout.dat"
	set constFileHdlTvIn     "window_avg.autohdltvin.dat"
	set constFileHdlTvOut    "window_avg.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
