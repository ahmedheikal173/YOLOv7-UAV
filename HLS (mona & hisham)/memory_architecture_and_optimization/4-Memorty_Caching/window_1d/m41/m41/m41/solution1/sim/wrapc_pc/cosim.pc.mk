...
$(ObjDir)/test_window_1d.cpp_pre.cpp.tb.o : test_window_1d.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling test_window_1d.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/window_1d_sliding.cpp_pre.cpp.tb.o : window_1d_sliding.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling window_1d_sliding.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
