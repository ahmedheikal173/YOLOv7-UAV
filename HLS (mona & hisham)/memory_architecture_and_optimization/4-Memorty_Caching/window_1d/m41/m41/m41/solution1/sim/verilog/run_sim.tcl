...
if {[file isfile window_avg.autotvin.dat]} {
	file delete -force window_avg.autotvin.dat
}

if {[file isfile window_avg.autotvout.dat]} {
	file delete -force window_avg.autotvout.dat
}
