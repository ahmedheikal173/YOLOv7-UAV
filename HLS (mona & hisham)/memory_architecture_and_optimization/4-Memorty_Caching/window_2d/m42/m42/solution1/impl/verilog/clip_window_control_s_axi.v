...
// ==============================================================
`timescale 1ns/1ps
module clip_window_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_R_DATA_0      = 6'h10,
    ADDR_R_CTRL        = 6'h14,
    ADDR_WINDOW_DATA_0 = 6'h18,
    ADDR_WINDOW_DATA_1 = 6'h1c,
    ADDR_WINDOW_CTRL   = 6'h20,
    WRIDLE             = 2'd0,
    WRDATA             = 2'd1,
    WRRESP             = 2'd2,
    WRRESET            = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_WINDOW_DATA_0: begin
                    rdata <= int_window[31:0];
                end
                ADDR_WINDOW_DATA_1: begin
                    rdata <= int_window[63:32];
                end
            endcase
        end
    end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_WINDOW_DATA_0)
            int_window[31:0] <= (WDATA[31:0] & wmask) | (int_window[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_WINDOW_DATA_1)
            int_window[63:32] <= (WDATA[31:0] & wmask) | (int_window[63:32] & ~wmask);
    end
end
