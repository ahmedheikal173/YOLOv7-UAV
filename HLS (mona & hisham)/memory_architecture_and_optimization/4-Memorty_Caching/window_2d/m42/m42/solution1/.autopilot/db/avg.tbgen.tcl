...
set C_modelArgList {
	{ din int 8 regular {bram 409600 { 1 1 } 1 1 }  }
	{ dout int 8 regular {bram 409600 { 0 3 } 0 1 }  }
...
set portList { 
	...
	{ din_Addr_B sc_out sc_lv 32 signal 0 } 
	{ din_EN_B sc_out sc_logic 1 signal 0 } 
	{ din_WEN_B sc_out sc_lv 1 signal 0 } 
	{ din_Din_B sc_out sc_lv 8 signal 0 } 
	{ din_Dout_B sc_in sc_lv 8 signal 0 } 
	{ din_Clk_B sc_out sc_logic 1 signal 0 } 
	{ din_Rst_B sc_out sc_logic 1 signal 0 } 
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"avg","role":"start","value":"0","valid_bit":"0"},{"name":"avg","role":"continue","value":"0","valid_bit":"4"},{"name":"avg","role":"auto_start","value":"0","valid_bit":"7"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"avg","role":"start","value":"0","valid_bit":"0"},{"name":"avg","role":"done","value":"0","valid_bit":"1"},{"name":"avg","role":"idle","value":"0","valid_bit":"2"},{"name":"avg","role":"ready","value":"0","valid_bit":"3"},{"name":"avg","role":"auto_start","value":"0","valid_bit":"7"},{"name":"ap_local_deadlock","role":"data","value":"0"}] },
	...
	{ "name": "interrupt", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "control", "role": "interrupt" } }, 
 	...
 	{ "name": "din_Addr_B", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "din", "role": "Addr_B" }} , 
 	{ "name": "din_EN_B", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "din", "role": "EN_B" }} , 
 	{ "name": "din_WEN_B", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "din", "role": "WEN_B" }} , 
 	{ "name": "din_Din_B", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "din", "role": "Din_B" }} , 
 	{ "name": "din_Dout_B", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "din", "role": "Dout_B" }} , 
 	{ "name": "din_Clk_B", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "din", "role": "Clk_B" }} , 
 	{ "name": "din_Rst_B", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "din", "role": "Rst_B" }} , 
...
set ArgLastReadFirstWriteLatency {
	avg {
		din {Type I LastRead 2 FirstWrite -1}
		dout {Type O LastRead -1 FirstWrite 2}
...
set PerformanceInfo {[
	...
	, {"Name" : "Interval", "Min" : "819203", "Max" : "819203"}
]}
...
set Spec2ImplPortList { 
	din { bram {  { din_Addr_A MemPortADDR2 1 32 }  { din_EN_A MemPortCE2 1 1 }  { din_WEN_A MemPortWE2 1 1 }  { din_Din_A MemPortDIN2 1 8 }  { din_Dout_A MemPortDOUT2 0 8 }  { din_Clk_A mem_clk 1 1 }  { din_Rst_A mem_rst 1 1 }  { din_Addr_B MemPortADDR2 1 32 }  { din_EN_B MemPortCE2 1 1 }  { din_WEN_B MemPortWE2 1 1 }  { din_Din_B MemPortDIN2 1 8 }  { din_Dout_B MemPortDOUT2 0 8 }  { din_Clk_B mem_clk 1 1 }  { din_Rst_B mem_rst 1 1 } } }
