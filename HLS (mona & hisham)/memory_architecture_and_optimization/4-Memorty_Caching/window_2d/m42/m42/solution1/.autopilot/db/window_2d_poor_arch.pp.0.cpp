...
# 2 "<built-in>" 2
# 1 "../src/window_2d_poor_arch.cpp" 2
...
# 2 "../src/window_2d_poor_arch.cpp" 2
# 1 "../src/../include/ap_fixed.h" 1
# 3 "../src/window_2d_poor_arch.cpp" 2
# 1 "../src/./window_2d.h" 1
...
__attribute__((sdx_kernel("avg", 0))) void avg(ap_uint<8> din[640][640], ap_uint<8> dout[640][640]);
void window_avg(ap_uint<8> din[640][640], ap_uint<8> dout[640][640]);
void clip_window(int r, ap_uint<8> window[3]);
# 4 "../src/window_2d_poor_arch.cpp" 2
...
__attribute__((sdx_kernel("avg", 0))) void avg(ap_uint<8> din[640][640], ap_uint<8> dout[640][640]) {_ssdm_SpecArrayDimSize(din, 640);_ssdm_SpecArrayDimSize(dout, 640);
#pragma HLSDIRECTIVE TOP name=avg
# 14 "../src/window_2d_poor_arch.cpp"
