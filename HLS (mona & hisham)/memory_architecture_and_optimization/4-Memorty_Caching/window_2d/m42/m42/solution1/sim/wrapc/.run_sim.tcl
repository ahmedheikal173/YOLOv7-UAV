...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "avg.autotvin.dat"
	set constFileTvOut       "avg.autotvout.dat"
	set constFileHdlTvIn     "avg.autohdltvin.dat"
	set constFileHdlTvOut    "avg.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
