...
// wrapc file define:
#define AUTOTB_TVIN_din "../tv/cdatafile/c.avg.autotvin_din.dat"
#define AUTOTB_TVOUT_din "../tv/cdatafile/c.avg.autotvout_din.dat"
// wrapc file define:
#define AUTOTB_TVIN_dout "../tv/cdatafile/c.avg.autotvin_dout.dat"
#define AUTOTB_TVOUT_dout "../tv/cdatafile/c.avg.autotvout_dout.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_din "../tv/rtldatafile/rtl.avg.autotvout_din.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_dout "../tv/rtldatafile/rtl.avg.autotvout_dout.dat"
...
static bool RTLOutputCheckAndReplacement(std::string &AESL_token, std::string PortName) {
  ...
  return err;}
extern "C" void avg_hw_stub_wrapper(volatile void *, volatile void *);
...
tr.reorder();
tr.send<1>((char*)__xlx_apatb_param_dout, 409600);
}
#else
{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<8> > dout_pc_buffer(409600);
          int i = 0;
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 409600; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_dout)[j*1+0] = dout_pc_buffer[i].range(7, 0).to_int64();
}}}
        } // end transaction
      } // end file is good
...
tr.import<1>((char*)__xlx_apatb_param_din, 409600, 0);
  }
tr.reorder();
aesl_fh.write(AUTOTB_TVIN_din, tr.p, tr.tbytes);
}

  tcl_file.set_num(409600, &tcl_file.din_depth);
#else
...
tr.import<1>((char*)__xlx_apatb_param_dout, 409600, 0);
  }
tr.reorder();
aesl_fh.write(AUTOTB_TVIN_dout, tr.p, tr.tbytes);
}

  tcl_file.set_num(409600, &tcl_file.dout_depth);
#else
...
avg_hw_stub_wrapper(__xlx_apatb_param_din, __xlx_apatb_param_dout);
