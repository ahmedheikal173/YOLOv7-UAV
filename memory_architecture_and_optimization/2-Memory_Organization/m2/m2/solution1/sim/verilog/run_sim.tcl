...
if {[file isfile interleave_manual_rnd.autotvin.dat]} {
	file delete -force interleave_manual_rnd.autotvin.dat
}

if {[file isfile interleave_manual_rnd.autotvout.dat]} {
	file delete -force interleave_manual_rnd.autotvout.dat
}
