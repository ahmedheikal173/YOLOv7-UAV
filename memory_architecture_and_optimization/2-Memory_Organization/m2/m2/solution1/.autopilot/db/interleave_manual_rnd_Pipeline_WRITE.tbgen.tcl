...
set C_modelArgList {
	{ temp_V int 8 regular {array 409600 { 0 3 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "temp_V", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ temp_V_address0 sc_out sc_lv 19 signal 0 } 
	{ temp_V_ce0 sc_out sc_logic 1 signal 0 } 
	{ temp_V_we0 sc_out sc_logic 1 signal 0 } 
	{ temp_V_d0 sc_out sc_lv 8 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "temp_V_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "temp_V", "role": "d0" }} , 
...
set Spec2ImplPortList { 
	temp_V { ap_memory {  { temp_V_address0 mem_address 1 19 }  { temp_V_ce0 mem_ce 1 1 }  { temp_V_we0 mem_we 1 1 }  { temp_V_d0 mem_din 1 8 } } }
