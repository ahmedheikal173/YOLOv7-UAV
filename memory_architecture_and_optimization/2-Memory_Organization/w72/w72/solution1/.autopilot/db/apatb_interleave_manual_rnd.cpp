...
// wrapc file define:
#define AUTOTB_TVIN_gmem "../tv/cdatafile/c.interleave_manual_rnd.autotvin_gmem.dat"
#define AUTOTB_TVOUT_gmem "../tv/cdatafile/c.interleave_manual_rnd.autotvout_gmem.dat"
// wrapc file define:
#define AUTOTB_TVIN_x_in "../tv/cdatafile/c.interleave_manual_rnd.autotvin_x_in.dat"
#define AUTOTB_TVOUT_x_in "../tv/cdatafile/c.interleave_manual_rnd.autotvout_x_in.dat"
// wrapc file define:
#define AUTOTB_TVIN_y "../tv/cdatafile/c.interleave_manual_rnd.autotvin_y.dat"
#define AUTOTB_TVOUT_y "../tv/cdatafile/c.interleave_manual_rnd.autotvout_y.dat"
// wrapc file define:
#define AUTOTB_TVIN_load "../tv/cdatafile/c.interleave_manual_rnd.autotvin_load.dat"
#define AUTOTB_TVOUT_load "../tv/cdatafile/c.interleave_manual_rnd.autotvout_load.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_gmem "../tv/rtldatafile/rtl.interleave_manual_rnd.autotvout_gmem.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_x_in "../tv/rtldatafile/rtl.interleave_manual_rnd.autotvout_x_in.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_y "../tv/rtldatafile/rtl.interleave_manual_rnd.autotvout_y.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_load "../tv/rtldatafile/rtl.interleave_manual_rnd.autotvout_load.dat"
...
static bool RTLOutputCheckAndReplacement(std::string &AESL_token, std::string PortName) {
  ...
  return err;}
extern "C" void interleave_manual_rnd_hw_stub_wrapper(volatile void *, volatile void *, char);
...
tr.reorder();
tr.send<1>((char*)__xlx_apatb_param_x_in, 9);
tr.send<1>((char*)__xlx_apatb_param_y, 3);
}
#else
{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<8> > gmem_pc_buffer(12);
          int i = 0;
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 9; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_x_in)[j*1+0] = gmem_pc_buffer[i].range(7, 0).to_int64();
}
            for (int j = 0, e = 3; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_y)[j*1+0] = gmem_pc_buffer[i].range(7, 0).to_int64();
}}}
        } // end transaction
      } // end file is good
...
tr.import<1>((char*)__xlx_apatb_param_x_in, 9, 0);
  }
  __xlx_offset_byte_param_y = 9*1;
  if (__xlx_apatb_param_y) {
tr.import<1>((char*)__xlx_apatb_param_y, 3, 0);
  }
tr.reorder();
...
interleave_manual_rnd_hw_stub_wrapper(__xlx_apatb_param_x_in, __xlx_apatb_param_y, __xlx_apatb_param_load);
