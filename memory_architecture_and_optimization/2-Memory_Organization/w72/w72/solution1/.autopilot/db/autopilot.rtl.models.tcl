set SynModuleInfo {
  ...
  {SRCNAME interleave_manual_rnd MODELNAME interleave_manual_rnd RTLNAME interleave_manual_rnd IS_TOP 1
    SUBMODULES {
      {MODELNAME interleave_manual_rnd_x_x0_V_RAM_1P_BRAM_1R1W RTLNAME interleave_manual_rnd_x_x0_V_RAM_1P_BRAM_1R1W BINDTYPE storage TYPE ram_1p IMPL bram LATENCY 2 ALLOW_PRAGMA 1}
      ...
      {MODELNAME interleave_manual_rnd_gmem_m_axi RTLNAME interleave_manual_rnd_gmem_m_axi BINDTYPE interface TYPE interface_m_axi}
    }
  }
}
