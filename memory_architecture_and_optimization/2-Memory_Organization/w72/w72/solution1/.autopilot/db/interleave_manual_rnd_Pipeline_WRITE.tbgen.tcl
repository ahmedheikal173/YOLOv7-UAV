set moduleName interleave_manual_rnd_Pipeline_WRITE
set isTopModule 0
...
set C_modelName {interleave_manual_rnd_Pipeline_WRITE}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 8 regular {axi_master 1}  }
	{ y int 64 regular  }
	{ x_x0_V int 8 regular {array 3 { 1 } 1 1 } {global 0}  }
	{ x_x1_V int 8 regular {array 3 { 1 } 1 1 } {global 0}  }
	{ x_x2_V int 8 regular {array 3 { 1 } 1 1 } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "x_in","offset": { "type": "dynamic","port_name": "x_in","bundle": "control"},"direction": "READONLY"},{"cName": "y","offset": { "type": "dynamic","port_name": "y","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
...
set Spec2ImplPortList { 
	...
	x_x0_V { ap_memory {  { x_x0_V_address0 mem_address 1 2 }  { x_x0_V_ce0 mem_ce 1 1 }  { x_x0_V_q0 in_data 0 8 } } }
	x_x1_V { ap_memory {  { x_x1_V_address0 mem_address 1 2 }  { x_x1_V_ce0 mem_ce 1 1 }  { x_x1_V_q0 in_data 0 8 } } }
	x_x2_V { ap_memory {  { x_x2_V_address0 mem_address 1 2 }  { x_x2_V_ce0 mem_ce 1 1 }  { x_x2_V_q0 in_data 0 8 } } }
}
