...
set C_modelArgList {
	...
	{ dout int 64 regular  }
	{ add_ln70 int 5 regular  }
	{ regs_mem_V int 8 regular {array 9 { 1 3 } 1 1 } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "dout","offset": { "type": "dynamic","port_name": "dout","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "add_ln70", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
 	{ "Name" : "regs_mem_V", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ dout sc_in sc_lv 64 signal 1 } 
	{ add_ln70 sc_in sc_lv 5 signal 2 } 
	{ regs_mem_V_address0 sc_out sc_lv 4 signal 3 } 
	{ regs_mem_V_ce0 sc_out sc_logic 1 signal 3 } 
	{ regs_mem_V_q0 sc_in sc_lv 8 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln70", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "add_ln70", "role": "default" }} , 
 	{ "name": "regs_mem_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "regs_mem_V", "role": "address0" }} , 
 	{ "name": "regs_mem_V_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "regs_mem_V", "role": "ce0" }} , 
 	{ "name": "regs_mem_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "regs_mem_V", "role": "q0" }}  ]}
...
set Spec2ImplPortList { 
	...
	add_ln70 { ap_none {  { add_ln70 in_data 0 5 } } }
	regs_mem_V { ap_memory {  { regs_mem_V_address0 mem_address 1 4 }  { regs_mem_V_ce0 mem_ce 1 1 }  { regs_mem_V_q0 mem_dout 0 8 } } }
}
