...
set portList { 
	...
	{ add_ln70 sc_in sc_lv 5 signal 0 } 
	...
	{ regs_mem_V_address0 sc_out sc_lv 4 signal 2 } 
	{ regs_mem_V_ce0 sc_out sc_logic 1 signal 2 } 
	{ regs_mem_V_q0 sc_in sc_lv 8 signal 2 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	dout { bram {  { dout_Addr_A MemPortADDR2 1 32 }  { dout_EN_A MemPortCE2 1 1 }  { dout_WEN_A MemPortWE2 1 1 }  { dout_Din_A MemPortDIN2 1 8 }  { dout_Dout_A MemPortDOUT2 0 8 } } }
	regs_mem_V { ap_memory {  { regs_mem_V_address0 mem_address 1 4 }  { regs_mem_V_ce0 mem_ce 1 1 }  { regs_mem_V_q0 in_data 0 8 } } }
}
