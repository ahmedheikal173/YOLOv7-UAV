...
set C_modelArgList {
	{ add_ln70 int 4 regular  }
	{ shiftreg_out int 512 regular {pointer 1}  }
	{ regs_mem int 32 regular {array 16 { 1 } 1 1 } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "add_ln70", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "shiftreg_out", "interface" : "wire", "bitwidth" : 512, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ add_ln70 sc_in sc_lv 4 signal 0 } 
	{ shiftreg_out sc_out sc_lv 512 signal 1 } 
	{ shiftreg_out_ap_vld sc_out sc_logic 1 outvld 1 } 
	{ regs_mem_address0 sc_out sc_lv 4 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln70", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "add_ln70", "role": "default" }} , 
 	{ "name": "shiftreg_out", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "shiftreg_out", "role": "default" }} , 
 	{ "name": "shiftreg_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "shiftreg_out", "role": "ap_vld" }} , 
 	{ "name": "regs_mem_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "regs_mem", "role": "address0" }} , 
...
set Spec2ImplPortList { 
	add_ln70 { ap_none {  { add_ln70 in_data 0 4 } } }
	shiftreg_out { ap_vld {  { shiftreg_out out_data 1 512 }  { shiftreg_out_ap_vld out_vld 1 1 } } }
	regs_mem { ap_memory {  { regs_mem_address0 mem_address 1 4 }  { regs_mem_ce0 mem_ce 1 1 }  { regs_mem_q0 in_data 0 32 } } }
}
