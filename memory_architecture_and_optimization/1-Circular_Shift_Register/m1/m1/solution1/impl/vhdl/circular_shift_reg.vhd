...
architecture behav of circular_shift_reg is 
    ...
    "circular_shift_reg_circular_shift_reg,hls_ip_2021_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcvu11p-flga2577-1-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.300000,HLS_SYN_LAT=89,HLS_SYN_TPT=none,HLS_SYN_MEM=59,HLS_SYN_DSP=0,HLS_SYN_FF=2251,HLS_SYN_LUT=2375,HLS_VERSION=2021_2}";
...
attribute shreg_extract of ap_rst_n_inv : signal is "no";
    ...
    signal regs_wptr_V : STD_LOGIC_VECTOR (21 downto 0) := "0000000000000000000000";
    signal regs_mem_address0 : STD_LOGIC_VECTOR (3 downto 0);
    signal regs_mem_ce0 : STD_LOGIC;
    signal regs_mem_we0 : STD_LOGIC;
    signal regs_mem_q0 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal trunc_ln70_fu_175_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal trunc_ln70_reg_215 : STD_LOGIC_VECTOR (3 downto 0);
    signal add_ln70_fu_179_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal add_ln70_reg_220 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal trunc_ln1_reg_225 : STD_LOGIC_VECTOR (57 downto 0);
    signal grp_circular_shift_reg_Pipeline_WRITE_fu_132_ap_start : STD_LOGIC;
    signal grp_circular_shift_reg_Pipeline_WRITE_fu_132_ap_done : STD_LOGIC;
    signal grp_circular_shift_reg_Pipeline_WRITE_fu_132_ap_idle : STD_LOGIC;
    signal grp_circular_shift_reg_Pipeline_WRITE_fu_132_ap_ready : STD_LOGIC;
    signal grp_circular_shift_reg_Pipeline_WRITE_fu_132_shiftreg_out : STD_LOGIC_VECTOR (511 downto 0);
    signal grp_circular_shift_reg_Pipeline_WRITE_fu_132_shiftreg_out_ap_vld : STD_LOGIC;
    signal grp_circular_shift_reg_Pipeline_WRITE_fu_132_regs_mem_address0 : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_circular_shift_reg_Pipeline_WRITE_fu_132_regs_mem_ce0 : STD_LOGIC;
    ...
    signal grp_circular_shift_reg_Pipeline_WRITE_fu_132_ap_start_reg : STD_LOGIC := '0';
    signal zext_ln587_fu_144_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln16_fu_195_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal select_ln31_fu_161_p3 : STD_LOGIC_VECTOR (21 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal add_ln885_fu_149_p2 : STD_LOGIC_VECTOR (21 downto 0);
    signal icmp_ln1064_fu_155_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    port (
        ...
        add_ln70 : IN STD_LOGIC_VECTOR (3 downto 0);
        shiftreg_out : OUT STD_LOGIC_VECTOR (511 downto 0);
        shiftreg_out_ap_vld : OUT STD_LOGIC;
        regs_mem_address0 : OUT STD_LOGIC_VECTOR (3 downto 0);
        regs_mem_ce0 : OUT STD_LOGIC;
        regs_mem_q0 : IN STD_LOGIC_VECTOR (31 downto 0) );
    end component;


    component circular_shift_reg_regs_mem_RAM_1P_BRAM_1R1W IS
    generic (
        DataWidth : INTEGER;
...
begin
    regs_mem_U : component circular_shift_reg_regs_mem_RAM_1P_BRAM_1R1W
    generic map (
        DataWidth => 32,
        AddressRange => 16,
        AddressWidth => 4)
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        address0 => regs_mem_address0,
        ce0 => regs_mem_ce0,
        we0 => regs_mem_we0,
        d0 => din,
        q0 => regs_mem_q0);

    grp_circular_shift_reg_Pipeline_WRITE_fu_132 : component circular_shift_reg_circular_shift_reg_Pipeline_WRITE
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ap_start => grp_circular_shift_reg_Pipeline_WRITE_fu_132_ap_start,
        ap_done => grp_circular_shift_reg_Pipeline_WRITE_fu_132_ap_done,
        ap_idle => grp_circular_shift_reg_Pipeline_WRITE_fu_132_ap_idle,
        ap_ready => grp_circular_shift_reg_Pipeline_WRITE_fu_132_ap_ready,
        add_ln70 => add_ln70_reg_220,
        shiftreg_out => grp_circular_shift_reg_Pipeline_WRITE_fu_132_shiftreg_out,
        shiftreg_out_ap_vld => grp_circular_shift_reg_Pipeline_WRITE_fu_132_shiftreg_out_ap_vld,
        regs_mem_address0 => grp_circular_shift_reg_Pipeline_WRITE_fu_132_regs_mem_address0,
        regs_mem_ce0 => grp_circular_shift_reg_Pipeline_WRITE_fu_132_regs_mem_ce0,
        regs_mem_q0 => regs_mem_q0);
    ...
    port map (
        ...
        I_WDATA => grp_circular_shift_reg_Pipeline_WRITE_fu_132_shiftreg_out,
    ...
    grp_circular_shift_reg_Pipeline_WRITE_fu_132_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                grp_circular_shift_reg_Pipeline_WRITE_fu_132_ap_start_reg <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
                    grp_circular_shift_reg_Pipeline_WRITE_fu_132_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_circular_shift_reg_Pipeline_WRITE_fu_132_ap_ready = ap_const_logic_1)) then 
                    grp_circular_shift_reg_Pipeline_WRITE_fu_132_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                add_ln70_reg_220 <= add_ln70_fu_179_p2;
                trunc_ln1_reg_225 <= dout(63 downto 6);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                regs_wptr_V <= select_ln31_fu_161_p3;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                trunc_ln70_reg_215 <= trunc_ln70_fu_175_p1;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state3, ap_CS_fsm_state4, ap_CS_fsm_state72, grp_circular_shift_reg_Pipeline_WRITE_fu_132_ap_done, gmem_AWREADY, gmem_WREADY, gmem_BVALID)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if ((not(((gmem_AWREADY = ap_const_logic_0) or (grp_circular_shift_reg_Pipeline_WRITE_fu_132_ap_done = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
    ...
    add_ln70_fu_179_p2 <= std_logic_vector(unsigned(trunc_ln70_reg_215) + unsigned(ap_const_lv4_F));
    add_ln885_fu_149_p2 <= std_logic_vector(unsigned(regs_wptr_V) + unsigned(ap_const_lv22_1));
    ...
    ap_ST_fsm_state3_blk_assign_proc : process(grp_circular_shift_reg_Pipeline_WRITE_fu_132_ap_done, gmem_AWREADY)
    begin
        if (((gmem_AWREADY = ap_const_logic_0) or (grp_circular_shift_reg_Pipeline_WRITE_fu_132_ap_done = ap_const_logic_0))) then 
    ...
    gmem_AWVALID_assign_proc : process(ap_CS_fsm_state3, grp_circular_shift_reg_Pipeline_WRITE_fu_132_ap_done, gmem_AWREADY)
    begin
        if ((not(((gmem_AWREADY = ap_const_logic_0) or (grp_circular_shift_reg_Pipeline_WRITE_fu_132_ap_done = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    grp_circular_shift_reg_Pipeline_WRITE_fu_132_ap_start <= grp_circular_shift_reg_Pipeline_WRITE_fu_132_ap_start_reg;
    icmp_ln1064_fu_155_p2 <= "1" when (add_ln885_fu_149_p2 = ap_const_lv22_10) else "0";

    regs_mem_address0_assign_proc : process(ap_CS_fsm_state1, ap_CS_fsm_state3, grp_circular_shift_reg_Pipeline_WRITE_fu_132_regs_mem_address0, zext_ln587_fu_144_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state1)) then 
            regs_mem_address0 <= zext_ln587_fu_144_p1(4 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            regs_mem_address0 <= grp_circular_shift_reg_Pipeline_WRITE_fu_132_regs_mem_address0;
        else 
            regs_mem_address0 <= "XXXX";
        end if; 
    end process;


    regs_mem_ce0_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, ap_CS_fsm_state3, grp_circular_shift_reg_Pipeline_WRITE_fu_132_regs_mem_ce0)
    begin
        if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            regs_mem_ce0 <= ap_const_logic_1;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            regs_mem_ce0 <= grp_circular_shift_reg_Pipeline_WRITE_fu_132_regs_mem_ce0;
        else 
            regs_mem_ce0 <= ap_const_logic_0;
        end if; 
    end process;


    regs_mem_we0_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1)
    begin
        if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            regs_mem_we0 <= ap_const_logic_1;
        else 
            regs_mem_we0 <= ap_const_logic_0;
        end if; 
    end process;

    select_ln31_fu_161_p3 <= 
        ap_const_lv22_0 when (icmp_ln1064_fu_155_p2(0) = '1') else 
        add_ln885_fu_149_p2;
        sext_ln16_fu_195_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln1_reg_225),64));

    trunc_ln70_fu_175_p1 <= select_ln31_fu_161_p3(4 - 1 downto 0);
    zext_ln587_fu_144_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(regs_wptr_V),64));
end behav;
