...
entity shift_reg_shift_reg_Pipeline_WRITE is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of shift_reg_shift_reg_Pipeline_WRITE is 
...
attribute shreg_extract : string;
    ...
    signal regs_V_load_reg_150 : STD_LOGIC_VECTOR (7 downto 0);
    signal i_1_cast_fu_119_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln35_fu_107_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    i_fu_62 <= add_ln35_fu_113_p2;
    ...
    add_ln35_fu_113_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_1) + unsigned(ap_const_lv4_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln35_fu_107_p2)
    begin
        if (((icmp_ln35_fu_107_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    i_1_cast_fu_119_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_1),64));
    icmp_ln35_fu_107_p2 <= "1" when (ap_sig_allocacmp_i_1 = ap_const_lv4_9) else "0";
    ...
    m_axi_gmem_WDATA <= regs_V_load_reg_150;
    ...
    regs_V_address0 <= i_1_cast_fu_119_p1(4 - 1 downto 0);

    regs_V_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_11001)
    begin
