...
if {[file isfile circular_shift_reg.autotvin.dat]} {
	file delete -force circular_shift_reg.autotvin.dat
}

if {[file isfile circular_shift_reg.autotvout.dat]} {
	file delete -force circular_shift_reg.autotvout.dat
}
