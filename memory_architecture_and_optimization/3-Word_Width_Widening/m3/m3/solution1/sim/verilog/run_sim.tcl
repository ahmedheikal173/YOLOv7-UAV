...
if {[file isfile word_width.autotvin.dat]} {
	file delete -force word_width.autotvin.dat
}

if {[file isfile word_width.autotvout.dat]} {
	file delete -force word_width.autotvout.dat
}
