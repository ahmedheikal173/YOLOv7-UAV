...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "word_width.autotvin.dat"
	set constFileTvOut       "word_width.autotvout.dat"
	set constFileHdlTvIn     "word_width.autohdltvin.dat"
	set constFileHdlTvOut    "word_width.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
