...
// ==============================================================
`timescale 1 ns / 1 ps
module word_width_word_width_ap_int_8_ap_int_8_bool_x_RAM_1P_BRAM_1R1W (address0, ce0, d0, we0, q0,  reset,clk);
...
initial begin
    $readmemh("./word_width_word_width_ap_int_8_ap_int_8_bool_x_RAM_1P_BRAM_1R1W.dat", ram);
end
