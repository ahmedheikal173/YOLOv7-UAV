...
void XWord_width_Set_x_in(XWord_width *InstancePtr, u64 Data) {
    ...
    XWord_width_WriteReg(InstancePtr->Control_BaseAddress, XWORD_WIDTH_CONTROL_ADDR_X_IN_DATA, (u32)(Data));
    XWord_width_WriteReg(InstancePtr->Control_BaseAddress, XWORD_WIDTH_CONTROL_ADDR_X_IN_DATA + 4, (u32)(Data >> 32));
}
...
u64 XWord_width_Get_x_in(XWord_width *InstancePtr) {
    ...
    Data = XWord_width_ReadReg(InstancePtr->Control_BaseAddress, XWORD_WIDTH_CONTROL_ADDR_X_IN_DATA);
    Data += (u64)XWord_width_ReadReg(InstancePtr->Control_BaseAddress, XWORD_WIDTH_CONTROL_ADDR_X_IN_DATA + 4) << 32;
    return Data;
}
...
void XWord_width_Set_y(XWord_width *InstancePtr, u64 Data) {
    ...
    XWord_width_WriteReg(InstancePtr->Control_BaseAddress, XWORD_WIDTH_CONTROL_ADDR_Y_DATA, (u32)(Data));
    XWord_width_WriteReg(InstancePtr->Control_BaseAddress, XWORD_WIDTH_CONTROL_ADDR_Y_DATA + 4, (u32)(Data >> 32));
}
...
u64 XWord_width_Get_y(XWord_width *InstancePtr) {
    ...
    Data = XWord_width_ReadReg(InstancePtr->Control_BaseAddress, XWORD_WIDTH_CONTROL_ADDR_Y_DATA);
    Data += (u64)XWord_width_ReadReg(InstancePtr->Control_BaseAddress, XWORD_WIDTH_CONTROL_ADDR_Y_DATA + 4) << 32;
    return Data;
}
