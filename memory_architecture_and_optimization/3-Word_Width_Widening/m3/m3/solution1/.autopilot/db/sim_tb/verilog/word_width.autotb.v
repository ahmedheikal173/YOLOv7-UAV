...
`define AUTOTB_DUT      word_width
`define AUTOTB_DUT_INST AESL_inst_word_width
`define AUTOTB_TOP      apatb_word_width_top
`define AUTOTB_LAT_RESULT_FILE "word_width.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "word_width.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_word_width_top
...
`define AUTOTB_TVIN_x_in  "./c.word_width.autotvin_x_in.dat"
`define AUTOTB_TVIN_y  "./c.word_width.autotvin_y.dat"
`define AUTOTB_TVIN_load  "./c.word_width.autotvin_load.dat"
`define AUTOTB_TVIN_x_in_out_wrapc  "./rtl.word_width.autotvin_x_in.dat"
`define AUTOTB_TVIN_y_out_wrapc  "./rtl.word_width.autotvin_y.dat"
`define AUTOTB_TVIN_load_out_wrapc  "./rtl.word_width.autotvin_load.dat"
`define AUTOTB_TVOUT_y  "./c.word_width.autotvout_y.dat"
`define AUTOTB_TVOUT_y_out_wrapc  "./impl_rtl.word_width.autotvout_y.dat"
module `AUTOTB_TOP;
