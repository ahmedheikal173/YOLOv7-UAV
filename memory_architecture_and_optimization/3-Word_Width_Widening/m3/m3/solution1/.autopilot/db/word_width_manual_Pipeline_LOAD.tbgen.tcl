set moduleName word_width_manual_Pipeline_LOAD
set isTopModule 0
...
set C_modelName {word_width_manual_Pipeline_LOAD}
set C_modelType { void 0 }
set C_modelArgList {
	{ x_idx_V_load int 21 regular  }
	{ x_write3_V_load int 24 regular  }
	{ x_sel_wr_V_load int 2 regular  }
	...
	{ p_Val2_out int 24 regular {pointer 1}  }
	{ p_out int 2 regular {pointer 1}  }
	{ x_x_V int 24 regular {array 409600 { 0 } 0 1 } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "x_idx_V_load", "interface" : "wire", "bitwidth" : 21, "direction" : "READONLY"} , 
 	{ "Name" : "x_write3_V_load", "interface" : "wire", "bitwidth" : 24, "direction" : "READONLY"} , 
 	{ "Name" : "x_sel_wr_V_load", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
 	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "x_in","offset": { "type": "dynamic","port_name": "x_in","bundle": "control"},"direction": "READONLY"},{"cName": "y","offset": { "type": "dynamic","port_name": "y","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "p_Val2_out", "interface" : "wire", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
 	{ "Name" : "p_out", "interface" : "wire", "bitwidth" : 2, "direction" : "WRITEONLY"} , 
 	{ "Name" : "x_x_V", "interface" : "memory", "bitwidth" : 24, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ x_write3_V_load sc_in sc_lv 24 signal 1 } 
	{ x_sel_wr_V_load sc_in sc_lv 2 signal 2 } 
	{ sext_ln15 sc_in sc_lv 58 signal 4 } 
	{ x_idx_V_flag_0_out sc_out sc_lv 1 signal 5 } 
	{ x_idx_V_flag_0_out_ap_vld sc_out sc_logic 1 outvld 5 } 
	{ x_idx_V_new_0_out sc_out sc_lv 21 signal 6 } 
	{ x_idx_V_new_0_out_ap_vld sc_out sc_logic 1 outvld 6 } 
	{ p_Val2_out sc_out sc_lv 24 signal 7 } 
	{ p_Val2_out_ap_vld sc_out sc_logic 1 outvld 7 } 
	{ p_out sc_out sc_lv 2 signal 8 } 
	{ p_out_ap_vld sc_out sc_logic 1 outvld 8 } 
	{ x_x_V_address0 sc_out sc_lv 19 signal 9 } 
	{ x_x_V_ce0 sc_out sc_logic 1 signal 9 } 
	{ x_x_V_we0 sc_out sc_logic 1 signal 9 } 
	{ x_x_V_d0 sc_out sc_lv 24 signal 9 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "x_write3_V_load", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "x_write3_V_load", "role": "default" }} , 
 	{ "name": "x_sel_wr_V_load", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "x_sel_wr_V_load", "role": "default" }} , 
 	...
 	{ "name": "p_Val2_out", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "p_Val2_out", "role": "default" }} , 
 	{ "name": "p_Val2_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "p_Val2_out", "role": "ap_vld" }} , 
 	{ "name": "p_out", "direction": "out", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "p_out", "role": "default" }} , 
 	...
 	{ "name": "x_x_V_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "x_x_V", "role": "we0" }} , 
 	{ "name": "x_x_V_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "x_x_V", "role": "d0" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1228803", "Max" : "1228803"}
	, {"Name" : "Interval", "Min" : "1228803", "Max" : "1228803"}
]}
...
set Spec2ImplPortList { 
	...
	x_write3_V_load { ap_none {  { x_write3_V_load in_data 0 24 } } }
	x_sel_wr_V_load { ap_none {  { x_sel_wr_V_load in_data 0 2 } } }
	...
	p_Val2_out { ap_vld {  { p_Val2_out out_data 1 24 }  { p_Val2_out_ap_vld out_vld 1 1 } } }
	p_out { ap_vld {  { p_out out_data 1 2 }  { p_out_ap_vld out_vld 1 1 } } }
	x_x_V { ap_memory {  { x_x_V_address0 mem_address 1 19 }  { x_x_V_ce0 mem_ce 1 1 }  { x_x_V_we0 mem_we 1 1 }  { x_x_V_d0 mem_din 1 24 } } }
}
