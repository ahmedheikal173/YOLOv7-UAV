; ModuleID = 'D:/gam3a/zzzzzzzzzz/3-Word_Width_Widening/m3/m3/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_word_width_manual_ir(%"struct.ap_int<8>"* %x_in, %"struct.ap_int<8>"* %y, i1 %load) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_word_width_manual_hw(i8* %2, i8* %3, i1 %load)
...
entry:
  call fastcc void @"onebyonecpy_hls.p0a1228800struct.ap_int<8>.156"([1228800 x i8]* %1, [1228800 x %"struct.ap_int<8>"]* %0)
...
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0a409600struct.ap_int<8>.150"([409600 x %"struct.ap_int<8>"]* %2, [409600 x i8]* %3)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0a409600struct.ap_int<8>.150"([409600 x %"struct.ap_int<8>"]* noalias, [409600 x i8]* noalias readonly) unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0a1228800struct.ap_int<8>.156"([1228800 x i8]* noalias, [1228800 x %"struct.ap_int<8>"]* noalias readonly) unnamed_addr #2 {
entry:
...
declare void @apatb_word_width_manual_hw(i8*, i8*, i1)

define void @word_width_manual_hw_stub_wrapper(i8*, i8*, i1) #4 {
entry:
  ...
  call void @word_width_manual_hw_stub(%"struct.ap_int<8>"* %7, %"struct.ap_int<8>"* %8, i1 %2)
  call void @copy_in([1228800 x %"struct.ap_int<8>"]* %3, [1228800 x i8]* %5, [409600 x %"struct.ap_int<8>"]* %4, [409600 x i8]* %6)
  ret void
}

declare void @word_width_manual_hw_stub(%"struct.ap_int<8>"*, %"struct.ap_int<8>"*, i1)
