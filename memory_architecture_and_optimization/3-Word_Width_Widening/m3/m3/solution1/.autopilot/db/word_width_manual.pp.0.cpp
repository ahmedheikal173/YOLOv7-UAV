...
# 2 "<built-in>" 2
# 1 "../src/word_width_manual.cpp" 2
# 1 "../src/./word_width.h" 1
...
__attribute__((sdx_kernel("word_width_manual", 0))) void word_width_manual(ap_int<8> x_in[(1228800)], ap_int<8> y[(1228800) / 3],
                bool load);
...
# 1 "../src/ww_read_mem.hpp" 1



# 1 "../src/../include/ap_int.h" 1
# 5 "../src/ww_read_mem.hpp" 2
...
# 26 "../src/./word_width_mem.hpp" 2
# 1 "../src/ww_write_mem.hpp" 1



# 1 "../src/../include/ap_int.h" 1
# 5 "../src/ww_write_mem.hpp" 2

template <int W, int N>
void word_width_mem<W, N>::write(ap_uint<(21)> i,
                                 ap_int<W> x_in[N]) {
