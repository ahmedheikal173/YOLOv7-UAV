...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename x_x_V \
    op interface \
    ports { x_x_V_address0 { O 19 vector } x_x_V_ce0 { O 1 bit } x_x_V_q0 { I 24 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'x_x_V'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_x_read3_V_load \
    op interface \
    ports { x_read3_V_load { I 24 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 2 \
    name x_sel_rd_V_load \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_x_sel_rd_V_load \
    op interface \
    ports { x_sel_rd_V_load { I 2 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 5 \
    name x_read3_V_flag_0_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_x_read3_V_flag_0_out \
    op interface \
    ports { x_read3_V_flag_0_out { O 1 vector } x_read3_V_flag_0_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 6 \
    name x_read3_V_new_0_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_x_read3_V_new_0_out \
    op interface \
    ports { x_read3_V_new_0_out { O 24 vector } x_read3_V_new_0_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_t_V_out \
    op interface \
    ports { t_V_out { O 2 vector } t_V_out_ap_vld { O 1 bit } } \
} "
}
...
set InstName word_width_manual_flow_control_loop_pipe_sequential_init_U
set CompName word_width_manual_flow_control_loop_pipe_sequential_init
set name flow_control_loop_pipe_sequential_init
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix word_width_manual_ \
}"
} else {
