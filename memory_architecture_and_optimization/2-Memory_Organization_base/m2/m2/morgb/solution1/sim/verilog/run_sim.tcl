...
if {[file isfile interleave_manual_seq.autotvin.dat]} {
	file delete -force interleave_manual_seq.autotvin.dat
}

if {[file isfile interleave_manual_seq.autotvout.dat]} {
	file delete -force interleave_manual_seq.autotvout.dat
}
