...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.interleave_manual_seq.autotvin_x_in.dat"
         "c.interleave_manual_seq.autotvin_y.dat"
         "c.interleave_manual_seq.autotvin_load.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.interleave_manual_seq.autotvout_y.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
