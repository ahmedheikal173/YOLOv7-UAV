...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "interleave_manual_seq.autotvin.dat"
	set constFileTvOut       "interleave_manual_seq.autotvout.dat"
	set constFileHdlTvIn     "interleave_manual_seq.autohdltvin.dat"
	set constFileHdlTvOut    "interleave_manual_seq.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
