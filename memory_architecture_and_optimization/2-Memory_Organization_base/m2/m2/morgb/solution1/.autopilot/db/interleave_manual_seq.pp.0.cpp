...
void interleave_manual_rnd(ap_int<8> x_in[1228800], ap_int<8> y[1228800 / 3],
                       bool load);
__attribute__((sdx_kernel("interleave_manual_seq", 0))) void interleave_manual_seq(ap_int<8> x_in[1228800], ap_int<8> y[1228800 / 3],
                       bool load);
...
__attribute__((sdx_kernel("interleave_manual_seq", 0))) void interleave_manual_seq(ap_int<8> x_in[1228800],
                           ap_int<8> y[1228800 / 3], bool load) {_ssdm_SpecArrayDimSize(x_in, 1228800);_ssdm_SpecArrayDimSize(y, 409600);
#pragma HLSDIRECTIVE TOP name=interleave_manual_seq
# 5 "../../src/interleave_manual_seq.cpp"
