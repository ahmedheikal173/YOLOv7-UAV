...
#pragma HLS BIND_STORAGE variable=mems type=RAM_T2P impl=BRAM
        ...
        void flt_load(ap_int<8> x_in[3564],ap_int<12> i){

                mems[i]=x_in[i];
        }

        ap_int<8> flt_read(ap_int<12> i){
...
void frommatrixF(ftype mmI_in, ap_int<8> mmI_out[3564]);
void tomatrixF(ap_int<8> mI_in[3564],ftype mI_out);
...
int idx=0;
  VITIS_LOOP_49_1: for (int k = 0; k < 44; k += 1){
    ...
    VITIS_LOOP_51_2: for (int i = 0; i < 9; i += 1){

      VITIS_LOOP_53_3: for (int j = 0; j < 9; j += 1){
#pragma HLS PIPELINE II=1
...
int idx=0;
  VITIS_LOOP_68_1: for (int k = 0; k < 44; k += 1){
    ...
    VITIS_LOOP_70_2: for (int i = 0; i < 9; i += 1){

      VITIS_LOOP_72_3: for (int j = 0; j < 9; j += 1){
#pragma HLS PIPELINE II=1
