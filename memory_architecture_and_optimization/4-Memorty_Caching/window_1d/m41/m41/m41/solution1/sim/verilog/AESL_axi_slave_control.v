...
//------------------------Parameter----------------------
`define TV_IN_din "../tv/cdatafile/c.window_avg.autotvin_din.dat"
`define TV_IN_dout "../tv/cdatafile/c.window_avg.autotvin_dout.dat"
...
parameter window_avg_continue_addr = 0;
parameter window_avg_auto_start_addr = 0;
        ...
        if (ongoing_process_number === process_num && process_busy === 0 ) begin
            ...
            if (write_din_run_flag === 1 && get_ack === 1) begin
                ...
                for (i = 0 ; i < four_byte_num ; i = i+1) begin
                    ...
                    if(image_mem_din[write_din_count * four_byte_num  + i]!==din_data_tmp_reg) begin
                    write (din_data_in_addr + write_din_count * four_byte_num * 4 + i * 4, din_data_tmp_reg, write_din_resp);
                    image_mem_din[write_din_count * four_byte_num + i]=din_data_tmp_reg;
                    end
                end
                process_busy = 0;
