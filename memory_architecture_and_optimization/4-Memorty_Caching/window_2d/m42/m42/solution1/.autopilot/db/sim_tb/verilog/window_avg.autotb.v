...
`define AUTOTB_DUT      window_avg
`define AUTOTB_DUT_INST AESL_inst_window_avg
`define AUTOTB_TOP      apatb_window_avg_top
`define AUTOTB_LAT_RESULT_FILE "window_avg.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "window_avg.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_window_avg_top
...
`define AUTOTB_TVIN_gmem  "./c.window_avg.autotvin_gmem.dat"
`define AUTOTB_TVIN_din  "./c.window_avg.autotvin_din.dat"
`define AUTOTB_TVIN_dout  "./c.window_avg.autotvin_dout.dat"
`define AUTOTB_TVIN_gmem_out_wrapc  "./rtl.window_avg.autotvin_gmem.dat"
`define AUTOTB_TVIN_din_out_wrapc  "./rtl.window_avg.autotvin_din.dat"
`define AUTOTB_TVIN_dout_out_wrapc  "./rtl.window_avg.autotvin_dout.dat"
`define AUTOTB_TVOUT_gmem  "./c.window_avg.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "./impl_rtl.window_avg.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 410384;
parameter LENGTH_gmem = 819200;
