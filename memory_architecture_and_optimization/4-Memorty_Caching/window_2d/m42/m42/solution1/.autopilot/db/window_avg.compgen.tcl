...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 4 \
			corename window_avg_control_axilite \
			name window_avg_control_s_axi \
			ports {$port_control} \
			op interface \
			interrupt_mode none \
			is_flushable 0 \
...
set InstName window_avg_flow_control_loop_pipe_U
set CompName window_avg_flow_control_loop_pipe
