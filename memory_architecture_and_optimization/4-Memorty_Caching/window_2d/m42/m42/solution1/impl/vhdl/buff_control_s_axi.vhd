...
-- 0x1c : reserved
-- 0x20 : Data signal of window
--        bit 31~0 - window[31:0] (Read/Write)
-- 0x24 : Data signal of window
--        bit 31~0 - window[63:32] (Read/Write)
-- 0x28 : reserved
-- (SC = Self Clear, COR = Clear on Read, TOW = Toggle on Write, COH = Clear on Handshake)

architecture behave of buff_control_s_axi is
    ...
    constant ADDR_WINDOW_DATA_0 : INTEGER := 16#20#;
    constant ADDR_WINDOW_DATA_1 : INTEGER := 16#24#;
    constant ADDR_WINDOW_CTRL   : INTEGER := 16#28#;
