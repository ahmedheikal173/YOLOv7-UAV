...
typedef ap_int<24> mtypeI[640][640/16][3];
# 24 "../src/./tomatrix.hpp"
void frommatrix(mtype mm_in, ap_int<8> mm_out[1228800]);
void tomatrix(ap_int<8> m_in[1228800],mtype m_out);


void frommatrixI(mtypeI mmI_in, ap_int<23> mmI_out[1228800/16]);
void tomatrixI(ap_int<23> mI_in[1228800/16],mtypeI mI_out);
# 6 "../src/./interleave.h" 2

# 1 "../src/../include/ap_int.h" 1
# 8 "../src/./interleave.h" 2

void interleave(ap_int<8> x_in[1228800], ap_int<23> y[1228800 / 16],
                bool load);
void img_interleave_manual_rnd(mtype x_in, mtypeI y,
                       bool load);
__attribute__((sdx_kernel("img_interleave_manual_seq", 0))) void img_interleave_manual_seq(mtype x_in, mtypeI y,
                       bool load);
...
#pragma HLS BIND_STORAGE variable=x15 type=RAM_T2P impl=BRAM
 ...
 idx = 0;
  ...
  void write_seq(ap_uint<(21)> i, T x_in[N]);
  T read_seq(ap_uint<(21)> i, int offset);
};
...
template <typename T, int N>
T interleave_mem_seq<T, N>::read_seq(ap_uint<(21)> i,
                                     int offset) {
  T tmp = 0;
  switch (offset) {
    case 0:
...
# 51 "../src/./interleave_mem_seq.hpp" 2
...
# 52 "../src/./interleave_mem_seq.hpp" 2
...
__attribute__((sdx_kernel("img_interleave_manual_seq", 0))) void img_interleave_manual_seq(mtype x_in,
                           mtypeI y, bool load) {_ssdm_SpecArrayDimSize(x_in, 640);_ssdm_SpecArrayDimSize(y, 640);
#pragma HLSDIRECTIVE TOP name=img_interleave_manual_seq
