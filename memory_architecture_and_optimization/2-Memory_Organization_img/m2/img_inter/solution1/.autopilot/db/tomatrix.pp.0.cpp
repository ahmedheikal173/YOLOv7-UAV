...
void tomatrix(ap_int<8> m_in[1228800],mtype m_out){
int idx=0;
  VITIS_LOOP_20_1: for (int k = 0; k < 3; k += 1){
    VITIS_LOOP_21_2: for (int i = 0; i < 640; i += 1){
      VITIS_LOOP_22_3: for (int j = 0; j < 640; j += 1){
...
void frommatrix(mtype mm_in, ap_int<8> mm_out[1228800]){
int idx=0;
  VITIS_LOOP_32_1: for (int k = 0; k < 3; k += 1){
    VITIS_LOOP_33_2: for (int i = 0; i < 640; i += 1){
...
void tomatrixI(ap_int<23> mI_in[1228800/16],mtypeI mI_out){
int idx=0;
  VITIS_LOOP_44_1: for (int k = 0; k < 3; k += 1){
    VITIS_LOOP_45_2: for (int i = 0; i < 640; i += 1){
      VITIS_LOOP_46_3: for (int j = 0; j < 640/16; j += 1){
...
void frommatrixI(mtypeI mmI_in, ap_int<23> mmI_out[1228800/16]){
int idx=0;
  VITIS_LOOP_56_1: for (int k = 0; k < 3; k += 1){
    VITIS_LOOP_57_2: for (int i = 0; i < 640; i += 1){
      VITIS_LOOP_58_3: for (int j = 0; j < 640/16; j += 1){
