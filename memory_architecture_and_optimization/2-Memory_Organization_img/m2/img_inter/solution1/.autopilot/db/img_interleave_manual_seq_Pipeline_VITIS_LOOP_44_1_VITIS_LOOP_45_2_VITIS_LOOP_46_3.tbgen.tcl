set moduleName img_interleave_manual_seq_Pipeline_VITIS_LOOP_44_1_VITIS_LOOP_45_2_VITIS_LOOP_46_3
set isTopModule 0
...
set C_modelName {img_interleave_manual_seq_Pipeline_VITIS_LOOP_44_1_VITIS_LOOP_45_2_VITIS_LOOP_46_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ y int 24 regular {bram 76800 { 0 3 } 0 1 }  }
	{ tmpy_V int 12 regular {array 76800 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "y", "interface" : "bram", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
 	{ "Name" : "tmpy_V", "interface" : "memory", "bitwidth" : 12, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ y_WEN_A sc_out sc_lv 4 signal 0 } 
	{ y_Din_A sc_out sc_lv 32 signal 0 } 
	{ y_Dout_A sc_in sc_lv 32 signal 0 } 
	{ tmpy_V_address0 sc_out sc_lv 17 signal 1 } 
	{ tmpy_V_ce0 sc_out sc_logic 1 signal 1 } 
	{ tmpy_V_q0 sc_in sc_lv 12 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tmpy_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "tmpy_V", "role": "address0" }} , 
 	{ "name": "tmpy_V_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "tmpy_V", "role": "ce0" }} , 
 	{ "name": "tmpy_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "tmpy_V", "role": "q0" }}  ]}
...
set Spec2ImplPortList { 
	y { bram {  { y_Addr_A MemPortADDR2 1 32 }  { y_EN_A MemPortCE2 1 1 }  { y_WEN_A MemPortWE2 1 4 }  { y_Din_A MemPortDIN2 1 32 }  { y_Dout_A MemPortDOUT2 0 32 } } }
	tmpy_V { ap_memory {  { tmpy_V_address0 mem_address 1 17 }  { tmpy_V_ce0 mem_ce 1 1 }  { tmpy_V_q0 in_data 0 12 } } }
}
