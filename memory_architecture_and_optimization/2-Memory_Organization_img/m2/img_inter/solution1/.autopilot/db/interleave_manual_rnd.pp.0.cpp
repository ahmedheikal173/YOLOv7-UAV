...
#pragma HLS BIND_STORAGE variable=x15 type=RAM_T2P impl=BRAM
  ...
  T read_rnd(ap_uint<(21)> i, int offset);
};
...
template <typename T, int N>
T interleave_mem_rnd<T, N>::read_rnd(ap_uint<(21)> i,
                             int offset) {
...
# 47 "../src/./interleave_mem_rnd.hpp" 2
...
# 48 "../src/./interleave_mem_rnd.hpp" 2
