...
// wrapc file define:
#define AUTOTB_TVIN_x_in "../tv/cdatafile/c.img_interleave_manual_seq.autotvin_x_in.dat"
#define AUTOTB_TVOUT_x_in "../tv/cdatafile/c.img_interleave_manual_seq.autotvout_x_in.dat"
// wrapc file define:
#define AUTOTB_TVIN_y "../tv/cdatafile/c.img_interleave_manual_seq.autotvin_y.dat"
#define AUTOTB_TVOUT_y "../tv/cdatafile/c.img_interleave_manual_seq.autotvout_y.dat"
// wrapc file define:
#define AUTOTB_TVIN_load "../tv/cdatafile/c.img_interleave_manual_seq.autotvin_load.dat"
#define AUTOTB_TVOUT_load "../tv/cdatafile/c.img_interleave_manual_seq.autotvout_load.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_x_in "../tv/rtldatafile/rtl.img_interleave_manual_seq.autotvout_x_in.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_y "../tv/rtldatafile/rtl.img_interleave_manual_seq.autotvout_y.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_load "../tv/rtldatafile/rtl.img_interleave_manual_seq.autotvout_load.dat"
...
static bool RTLOutputCheckAndReplacement(std::string &AESL_token, std::string PortName) {
  ...
  return err;}
extern "C" void img_interleave_manual_seq_hw_stub_wrapper(volatile void *, volatile void *, char);
...
{
transaction<24> tr(76800);
aesl_fh.read(AUTOTB_TVOUT_PC_y, tr.p, tr.tbytes);
tr.reorder();
tr.send<4>((char*)__xlx_apatb_param_y, 76800);
}
#else
{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<24> > y_pc_buffer(76800);
          int i = 0;
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 76800; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_y)[j*4+0] = y_pc_buffer[i].range(7, 0).to_int64();
...
tr.import<4>((char*)__xlx_apatb_param_y, 76800, 0);
  }
tr.reorder();
aesl_fh.write(AUTOTB_TVIN_y, tr.p, tr.tbytes);
}

  tcl_file.set_num(76800, &tcl_file.y_depth);
#else
...
sc_bv<24> __xlx_tmp_lv = ((int*)__xlx_apatb_param_y)[j];
...
img_interleave_manual_seq_hw_stub_wrapper(__xlx_apatb_param_x_in, __xlx_apatb_param_y, __xlx_apatb_param_load);
