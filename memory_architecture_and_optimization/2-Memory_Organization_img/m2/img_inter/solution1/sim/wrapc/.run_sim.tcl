...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "img_interleave_manual_seq.autotvin.dat"
	set constFileTvOut       "img_interleave_manual_seq.autotvout.dat"
	set constFileHdlTvIn     "img_interleave_manual_seq.autohdltvin.dat"
	set constFileHdlTvOut    "img_interleave_manual_seq.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
