...
attribute shreg_extract : string;
    ...
    signal indvars_iv551_fu_104 : STD_LOGIC_VECTOR (20 downto 0);
...
begin
    ...
    indvars_iv551_fu_104_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
                    indvars_iv551_fu_104 <= ap_const_lv21_0;
                elsif ((ap_enable_reg_pp0_iter2 = ap_const_logic_1)) then 
                    indvars_iv551_fu_104 <= select_ln32_4_fu_431_p3;
                end if;
            end if; 
        end if;
    end process;
    ...
    add_ln32_1_fu_411_p2 <= std_logic_vector(unsigned(indvars_iv551_fu_104) + unsigned(ap_const_lv21_64000));
