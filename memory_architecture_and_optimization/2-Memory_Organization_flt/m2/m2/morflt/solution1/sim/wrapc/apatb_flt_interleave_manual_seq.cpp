...
// wrapc file define:
#define AUTOTB_TVIN_x_in "../tv/cdatafile/c.flt_interleave_manual_seq.autotvin_x_in.dat"
#define AUTOTB_TVOUT_x_in "../tv/cdatafile/c.flt_interleave_manual_seq.autotvout_x_in.dat"
// wrapc file define:
#define AUTOTB_TVIN_y "../tv/cdatafile/c.flt_interleave_manual_seq.autotvin_y.dat"
#define AUTOTB_TVOUT_y "../tv/cdatafile/c.flt_interleave_manual_seq.autotvout_y.dat"
// wrapc file define:
#define AUTOTB_TVIN_load "../tv/cdatafile/c.flt_interleave_manual_seq.autotvin_load.dat"
#define AUTOTB_TVOUT_load "../tv/cdatafile/c.flt_interleave_manual_seq.autotvout_load.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_x_in "../tv/rtldatafile/rtl.flt_interleave_manual_seq.autotvout_x_in.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_y "../tv/rtldatafile/rtl.flt_interleave_manual_seq.autotvout_y.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_load "../tv/rtldatafile/rtl.flt_interleave_manual_seq.autotvout_load.dat"
...
static bool RTLOutputCheckAndReplacement(std::string &AESL_token, std::string PortName) {
  ...
  return err;}
extern "C" void flt_interleave_manual_seq_hw_stub_wrapper(volatile void *, volatile void *, char);

extern "C" void apatb_flt_interleave_manual_seq_hw(volatile void * __xlx_apatb_param_x_in, volatile void * __xlx_apatb_param_y, char __xlx_apatb_param_load) {
...
{
transaction<16> tr(396);
aesl_fh.read(AUTOTB_TVOUT_PC_y, tr.p, tr.tbytes);
tr.reorder();
tr.send<2>((char*)__xlx_apatb_param_y, 396);
}
#else
{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<16> > y_pc_buffer(396);
          int i = 0;
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 396; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_y)[j*2+0] = y_pc_buffer[i].range(7, 0).to_int64();
((char*)__xlx_apatb_param_y)[j*2+1] = y_pc_buffer[i].range(15, 8).to_int64();
}}}
        } // end transaction
      } // end file is good
...
transaction<8> tr(3564);
  __xlx_offset_byte_param_x_in = 0*1;
  if (__xlx_apatb_param_x_in) {
tr.import<1>((char*)__xlx_apatb_param_x_in, 3564, 0);
  }
tr.reorder();
aesl_fh.write(AUTOTB_TVIN_x_in, tr.p, tr.tbytes);
}

  tcl_file.set_num(3564, &tcl_file.x_in_depth);
#else
...
tr.import<2>((char*)__xlx_apatb_param_y, 396, 0);
  }
tr.reorder();
aesl_fh.write(AUTOTB_TVIN_y, tr.p, tr.tbytes);
}

  tcl_file.set_num(396, &tcl_file.y_depth);
#else
...
flt_interleave_manual_seq_hw_stub_wrapper(__xlx_apatb_param_x_in, __xlx_apatb_param_y, __xlx_apatb_param_load);
