...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "flt_interleave_manual_seq.autotvin.dat"
	set constFileTvOut       "flt_interleave_manual_seq.autotvout.dat"
	set constFileHdlTvIn     "flt_interleave_manual_seq.autohdltvin.dat"
	set constFileHdlTvOut    "flt_interleave_manual_seq.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
