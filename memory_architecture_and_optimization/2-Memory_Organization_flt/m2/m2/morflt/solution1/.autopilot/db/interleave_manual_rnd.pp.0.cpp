# 1 "../../src/interleave_manual_rnd.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 395 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../src/interleave_manual_rnd.cpp" 2
...
void flt_interleave_manual_seq(mtype x_in, mtypeI y,
                       bool load);
# 2 "../../src/interleave_manual_rnd.cpp" 2
# 1 "../../src/./interleave_mem_rnd.hpp" 1
...
# 1 "../../src/../include/ap_int.h" 1
# 7 "../../src/./interleave_mem_rnd.hpp" 2
...
class interleave_mem_rnd {
 ...
 public:
  interleave_mem_rnd() {
# 39 "../../src/./interleave_mem_rnd.hpp"
  }

  void write_rnd(ap_int<(12)> i, T x_in[N]);
  T read_rnd(ap_int<(12)> i, int offset);
};

# 1 "../../src/./read_mem_rnd.hpp" 1



# 1 "../../src/../include/ap_int.h" 1
# 5 "../../src/./read_mem_rnd.hpp" 2

template <typename T, int N>
T interleave_mem_rnd<T, N>::read_rnd(ap_int<(12)> i,
                             int offset) {
...
# 45 "../../src/./interleave_mem_rnd.hpp" 2
# 1 "../../src/./write_mem_rnd.hpp" 1



# 1 "../../src/../include/ap_int.h" 1
# 5 "../../src/./write_mem_rnd.hpp" 2

template <typename T, int N>
void interleave_mem_rnd<T, N>::write_rnd(ap_int<(12)> i,
                                 T x_in[N]) {
...
# 46 "../../src/./interleave_mem_rnd.hpp" 2
...
void frommatrixI(mtypeI mmI_in, ap_int<16> mmI_out[3564/9]);
void tomatrixI(ap_int<16> mI_in[3564/9],mtypeI mI_out);
# 4 "../../src/interleave_manual_rnd.cpp" 2

void flt_interleave_manual_rnd(mtype x_in,
                           mtypeI y, bool load) {
...
ap_int<16> temp[3564 / 9];
ap_int<8> tmpx[3564];

frommatrix(x_in,tmpx);

  static interleave_mem_rnd<ap_int<8>, 3564> x;
...
WRITE:
    for (int i = 0; i < 3564; i += 9){
#pragma HLS PIPELINE II=1
 temp[idx++] = x.read_rnd(i, 0) + x.read_rnd(i, 1) + x.read_rnd(i, 2)
                  + x.read_rnd(i, 3) + x.read_rnd(i, 4) + x.read_rnd(i, 5)
                  + x.read_rnd(i, 6) + x.read_rnd(i, 7) + x.read_rnd(i, 8);
    }
      tomatrixI(temp,y);
}
