# 1 "../../src/interleave_manual_seq.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 395 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../src/interleave_manual_seq.cpp" 2
# 1 "../../src/./interleave.h" 1
...
typedef ap_int<8> mtype[9][9][44];
typedef ap_int<16> mtypeI[9][9/9][44];
# 24 "../../src/./tomatrix.hpp"
void frommatrix(mtype mm_in, ap_int<8> mm_out[3564]);
void tomatrix(ap_int<8> m_in[3564],mtype m_out);


void frommatrixI(mtypeI mmI_in, ap_int<16> mmI_out[3564/9]);
void tomatrixI(ap_int<16> mI_in[3564/9],mtypeI mI_out);
# 6 "../../src/./interleave.h" 2

# 1 "../../src/../include/ap_int.h" 1
# 8 "../../src/./interleave.h" 2

void interleave(ap_int<8> x_in[3564], ap_int<16> y[3564 / 9],
                bool load);
void flt_interleave_manual_rnd(mtype x_in, mtypeI y,
                       bool load);
__attribute__((sdx_kernel("flt_interleave_manual_seq", 0))) void flt_interleave_manual_seq(mtype x_in, mtypeI y,
                       bool load);
# 2 "../../src/interleave_manual_seq.cpp" 2
# 1 "../../src/./interleave_mem_seq.hpp" 1
...
# 1 "../../src/../include/ap_int.h" 1
# 7 "../../src/./interleave_mem_seq.hpp" 2
...
class interleave_mem_seq {
 ...
 public:
  interleave_mem_seq() {
# 41 "../../src/./interleave_mem_seq.hpp"
 idx = 0;
    sel = 0;
  }

  void write_seq(ap_int<(12)> i, T x_in[N]);
  T read_seq(ap_int<(12)> i, int offset);
};

# 1 "../../src/./read_mem_seq.hpp" 1



# 1 "../../src/../include/ap_int.h" 1
# 5 "../../src/./read_mem_seq.hpp" 2

template <typename T, int N>
T interleave_mem_seq<T, N>::read_seq(ap_int<(12)> i,
                                     int offset) {
...
# 49 "../../src/./interleave_mem_seq.hpp" 2
# 1 "../../src/./write_mem_seq.hpp" 1



# 1 "../../src/../include/ap_int.h" 1
# 5 "../../src/./write_mem_seq.hpp" 2

template <typename T, int N>
void interleave_mem_seq<T, N>::write_seq(ap_int<(12)> i,
                                         T x_in[N]) {
...
# 50 "../../src/./interleave_mem_seq.hpp" 2
...
void frommatrixI(mtypeI mmI_in, ap_int<16> mmI_out[3564/9]);
void tomatrixI(ap_int<16> mI_in[3564/9],mtypeI mI_out);
# 4 "../../src/interleave_manual_seq.cpp" 2

__attribute__((sdx_kernel("flt_interleave_manual_seq", 0))) void flt_interleave_manual_seq(mtype x_in,
                           mtypeI y, bool load) {_ssdm_SpecArrayDimSize(x_in, 9);_ssdm_SpecArrayDimSize(y, 9);
#pragma HLSDIRECTIVE TOP name=flt_interleave_manual_seq
# 6 "../../src/interleave_manual_seq.cpp"
...
ap_int<16> tmpy[3564 / 9];
ap_int<8> tmpx[3564];



#pragma HLS interface mode=BRAM port=tmpy
#pragma HLS interface mode=BRAM port=tmpx
frommatrix(x_in,tmpx);

  static interleave_mem_seq<ap_int<8>, 3564> x;
