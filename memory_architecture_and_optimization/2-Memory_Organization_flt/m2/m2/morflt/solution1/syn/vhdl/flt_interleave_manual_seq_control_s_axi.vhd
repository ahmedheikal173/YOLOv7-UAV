...
entity flt_interleave_manual_seq_control_s_axi is
generic (
...
end entity flt_interleave_manual_seq_control_s_axi;
...
architecture behave of flt_interleave_manual_seq_control_s_axi is
...
-- ----------------------- Register logic ----------------
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_LOAD_DATA_0) then
                    int_load(0 downto 0) <= (UNSIGNED(WDATA(0 downto 0)) and wmask(0 downto 0)) or ((not wmask(0 downto 0)) and int_load(0 downto 0));
                end if;
            end if;
        end if;
    end process;
