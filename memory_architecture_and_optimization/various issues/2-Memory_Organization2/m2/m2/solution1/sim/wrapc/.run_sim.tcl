...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "interleave_manual_rnd.autotvin.dat"
	set constFileTvOut       "interleave_manual_rnd.autotvout.dat"
	set constFileHdlTvIn     "interleave_manual_rnd.autohdltvin.dat"
	set constFileHdlTvOut    "interleave_manual_rnd.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
